...
- `ipw()`: bring-your-own-model inverse probability weighted estimation
  of causal effects from a weighting model and a weighted outcome model.
- `ess()`: the effective sample size of a set of weights or a fitted
  model.
