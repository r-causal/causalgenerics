...
- [`print(`*`<ipw_pooled>`*`)`](https://r-causal.github.io/causalgenerics/reference/ipw-pooled-methods.md)
  [`coef(`*`<ipw_pooled>`*`)`](https://r-causal.github.io/causalgenerics/reference/ipw-pooled-methods.md)
  [`vcov(`*`<ipw_pooled>`*`)`](https://r-causal.github.io/causalgenerics/reference/ipw-pooled-methods.md)
